<script lang="ts">
	...
	import Progressbar from '$lib/components/HomeProgressbar.svelte';
	import sections from '$lib/components/sections/index';
	import { getWindowHeight, getDocHeight, progress, scrollEnabled, throttle } from '$lib/utils';
