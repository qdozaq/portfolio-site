...
<style type="scss">
  ...
  .circle {
    ...
    transition: background-color 0.3s var(--reaction-curve),
      width 0.3s var(--reaction-curve), height 0.3s var(--reaction-curve),
      box-shadow 0.3s var(--reaction-curve);
  ...
  .section-title {
    ...
    color: #8f8f8f;
    transition: opacity 0.3s var(--reaction-curve),
      transform 0.3s var(--reaction-curve);
  }
